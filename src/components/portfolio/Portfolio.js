...
const Portfolio = () => {
  return (
    <Container id="portfolio" fluid className="portfolioBg">
      <Container>
        <Row>
          <h3 className="my-4 pt-3">Projects</h3>
          <h5 style={{ color: "#a1a4a7" }}>Full Stack</h5>
          <ProjectCard
            picture={Pic5}
            title="Store"
            ...
            techIconsBack={
              <>
                ...
                <SiExpress className="skillsIcons" />
                <SiMongodb className="skillsIcons mongoIcon" />
                <span className="mongooseText">mongoose</span>
              </>
            }
            link="https://mern-shoe-store.herokuapp.com/"
          />
          <h5 style={{ color: "#a1a4a7" }} className="mt-5 mb-3">
            Front-End
          </h5>
          <Col md={6} className="pe-md-2">
            <Row className="projectDescription py-4 px-xl-5 px-3 me-md-1">
              ...
              <Col lg={8} className="portfolioLayout">
                <h4 className="mt-2 mt-lg-0 projectTitle">E-Travel App</h4>
                <div className="detailsWrap">
                  <div>
                    <p>
                      ...
                      E-travel is a travel applications with exotic
                      destinations. Built with React functional components and
                      more.
                    </p>
                  </div>
                  <div>
          ...
          <Col md={6} className="ps-md-2 mt-md-0 mt-4">
            <Row className="projectDescription py-4 px-xl-5 px-3 ms-md-1 h-100">
              ...
              <Col lg={8}>
                <h4 className="mt-2 mt-lg-0">Makeup App</h4>
                <div className="detailsWrap">
                  <div>
                    <p>
                      Makeup Beauty, this App is built upon practicing working
                      with public APIs, Fetching data with Axios async, routing
                      and more.
                    </p>
                  </div>
                  <div>
        ...
        <Row className="mt-4">
          <Col md={6} className="pe-md-2">
            <Row className="projectDescription py-4 px-xl-5 px-3 me-md-1">
              ...
              <Col lg={8}>
                <h4 className="mt-2 mt-lg-0">Quiz App</h4>
                <div className="detailsWrap">
                  <div>
                    <p>
          ...
          <Col md={6} className="ps-md-2 mt-md-0 mt-4">
            <Row className="projectDescription py-4 px-xl-5 px-3 ms-md-1 h-100">
              ...
              <Col lg={8}>
                <h4 className="mt-2 mt-lg-0">Ristoranti</h4>
                <div className="detailsWrap">
                  <div>
                    <p>Just a simple presentation website.</p>
                  </div>
                  <div>
                    <div className="divider"></div>
                    <div className="d-flex projectIcons">
                      <FaHtml5 className="skillsIcons htmlIcon" />
                      <FaCss3Alt className="skillsIcons cssIcon" />
                      <FaJsSquare className="skillsIcons jsIcon" />
